...
def parameter_parser():
    ...
    parser.add_argument("--alpha_1",
                        type=float,
                        default=1000.0,
	                help="Alignment param, adjacency matrix. Default is 1000.0.")

    parser.add_argument("--alpha_2",
                        type=float,
                        default=1.0,
	                help="Adjacency basis factor matrix regul param. Default is 1.0.")

    parser.add_argument("--alpha_3",
                        type=float,
                        default=1.0,
	                help="Adjacency feature factor matrix regul param. Default is 1.0.")

    parser.add_argument("--beta_1",
                        type=float,
                        default=1000.0,
	                help="Alignment param for feature matrix. Default is 1000.0.")

    parser.add_argument("--beta_2",
                        type=float,
                        default=1.0,
	                help="Node basis factor matrix regul param. Default is 1.0.")

    parser.add_argument("--beta_3",
                        type=float,
                        default=1.0,
	                help="Node feature factor matrix regul param. Default is 1.0.")
